 ...
 *  * @param {string} [props.variant] - The variant of the badge (e.g. "primary", "secondary").
 *  * @param {boolean} [props.asChild=false] - Whether to render the Badge as a child element.
