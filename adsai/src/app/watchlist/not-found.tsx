 ...
 *  * @description A React component that displays an empty state when a watchlist is not found.
 *  *
 ...
 *  * @returns {JSX.Element} The JSX element representing the watchlist not found page.
 */
  ...
  return (
    <main className="pt-24 pb-20 max-w-3xl mx-auto px-4 py-28">
      <EmptyState
        ...
        description={"We couldn't find a watchlist for this user. It may have been removed or the link might be incorrect."}
