...
/**
 * * RatingsNotFound component.
 *  *
 *  * @description Displays an empty state with a message indicating that ratings were not found for the user.
 *  *
 *  * @param {object} props - Component properties
 *  * @param {string} props.title - Title of the empty state
 *  * @param {string} props.description - Description of the empty state
 *  * @returns {JSX.Element} Empty state component with a message and two actions
 */
export default function RatingsNotFound() {
  return (
    <main className="pt-24 pb-20 max-w-3xl mx-auto px-4 py-28">
      <EmptyState
        ...
        title="Ratings not found"
        description={"We couldn't find ratings for this user. They may have been removed or the link might be incorrect."}
